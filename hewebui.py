...
class HawkEyeWebUi:
    ...
    def rerunscanmulti(self: 'HawkEyeWebUi', ids: str) -> str:
        ...
        templ = Template(filename='hawkeye/templates/scanlist.tmpl', lookup=self.lookup)
    ...
    def newscan(self: 'HawkEyeWebUi') -> str:
        ...
        templ = Template(filename='hawkeye/templates/newscan.tmpl', lookup=self.lookup)
    ...
    def scaninfo(self: 'HawkEyeWebUi', id: str) -> str:
        ...
        templ = Template(filename='hawkeye/templates/scaninfo.tmpl', lookup=self.lookup, input_encoding='utf-8')
    ...
    def opts(self: 'HawkEyeWebUi', updated: str = None) -> str:
        ...
        """
        templ = Template(filename='hawkeye/templates/opts.tmpl', lookup=self.lookup)
