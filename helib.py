...
class HawkEye:
    ...
    Attributes:
        ...
        scanId (str): scan ID this instance of HawkEye is being used in
    ...
    def scanId(self, scanId: str) -> str:
        """Set the scan ID this instance of HawkEye is being used in.
    ...
    def socksProxy(self, socksProxy: str) -> str:
        ...
        modules. hescan will call this to update the socket reference
        to the SOCKS one.
    ...
    def cachePut(self, label: str, data: str) -> None:
        ...
        cacheFile = HawkEyeHelpers.cachePath() + "/" + pathLabel
    ...
    def configSerialize(self, opts: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): Dictionary of HawkEye configuration options
    ...
    def configUnserialize(self, opts: dict, referencePoint: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): HawkEye configuration options
    ...
    def urlFQDN(self, url: str) -> str:
        ...
        baseurl = HawkEyeHelpers.urlBaseUrl(url)
        if '://' in baseurl:
            count = 2
        else:
            count = 0
    ...
    def validHost(self, hostname: str, tldList: str) -> bool:
        ...
        hex = ps.privatesuffix(hostname)
        return hex is not None
    ...
    def fetchUrl(
        ...
        if sizeLimit or headOnly:
            ...
            if newloc.startswith("/") or newloc.startswith("../"):
                newloc = HawkEyeHelpers.urlBaseUrl(url) + newloc
            ...
            try:
                ...
                if source == "circl":
                    ...
                    if rating:
                        ...
                        return (eventType, f"{cveId}\n<heURL>https://nvd.nist.gov/vuln/detail/{cveId}</heURL>\n"
