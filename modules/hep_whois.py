...
# -------------------------------------------------------------------------------
# Name:         hep_whois
# Purpose:      HawkEye plug-in for searching Whois servers for domain names
...
class hep_whois(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        rawevt = HawkEyeEvent(typ, data, self.__name__, event)
        ...
        if eventName.startswith("DOMAIN_NAME"):
            if whoisdata:
                ...
                if registrar:
                    evt = HawkEyeEvent("DOMAIN_REGISTRAR", registrar, self.__name__, event)
                    self.notifyListeners(evt)

# End of hep_whois class
