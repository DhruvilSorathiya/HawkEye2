...
class hep_circllu(HawkEyePlugin):
                ...
                try:
                    ...
                    for ip in j:
                        ...
                        for crt in j[ip]['subjects']:
                            ...
                            if r:
                                e = HawkEyeEvent("SSL_CERTIFICATE_ISSUED", r[0][0], self.__name__, ipe)
