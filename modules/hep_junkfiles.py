...
class hep_junkfiles(HawkEyePlugin):
    ...
    def checkValidity(self, junkUrl):
        ...
        res = self.he.fetchUrl(fetch, headOnly=True,
                               timeout=self.opts['_fetchtimeout'],
                               useragent=self.opts['_useragent'],
                               verify=False)
        if res['code'] != "404":
            host = HawkEyeHelpers.urlBaseUrl(junkUrl)
    ...
    def handleEvent(self, event):
        ...
        host = HawkEyeHelpers.urlBaseUrl(eventData)
            ...
            if "." + ext + "?" in eventData or "." + ext + "#" in eventData or \
                ...
                for x in self.opts['fileexts']:
                    ...
                    if res['code'] == "200":
                        ...
                        evt = HawkEyeEvent("JUNK_FILE", fetch, self.__name__, event)
                        self.notifyListeners(evt)

        base = HawkEyeHelpers.urlBaseDir(eventData)
