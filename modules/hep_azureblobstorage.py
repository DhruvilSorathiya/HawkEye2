# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_azureblobstorage
# Purpose:      HawkEye plug-in for identifying potential Azure blobs related
#               to the target.
#
...
class hep_azureblobstorage(HawkEyePlugin):
    ...
    def threadSites(self, siteList):
        ...
        for site in siteList:
            ...
            t.append(threading.Thread(name='thread_hep_azureblobstorages_' + tname,
        ...
        while running:
            ...
            for rt in threading.enumerate():
                if rt.name.startswith("thread_hep_azureblobstorages_"):
                    found = True
...
# End of hep_azureblobstorage class
