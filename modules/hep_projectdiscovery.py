...
class hep_projectdiscovery(HawkEyePlugin):
    meta = {
    ...
    def handleEvent(self, event):
        ...
        if self.opts["api_key"] == "":
            self.error(
                "You enabled hep_projectdiscovery but did not set an API key!"
            )
        ...
        for subdomain in subdomains:
            ...
            if self.opts["verify"] and not self.he.resolveHost(completeSubdomain) and not self.he.resolveHost6(completeSubdomain):
...
# End of hep_projectdiscovery class
