...
class hep_blockchain(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        # Wallet balance
        res = self.he.fetchUrl("https://blockchain.info/balance?active=" + eventData,
        ...
        evt = HawkEyeEvent("BITCOIN_BALANCE", str(balance) + " BTC", self.__name__, event)
        self.notifyListeners(evt)

# End of hep_blockchain class
