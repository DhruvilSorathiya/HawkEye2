...
class hep_blocklistde(HawkEyePlugin):
    ...
    def retrieveBlacklist(self):
        blacklist = self.he.cacheGet('blocklistde', 24)
        ...
        self.he.cachePut("blocklistde", res['content'])
    ...
    def parseBlacklist(self, blacklist):
        ...
        for ip in blacklist.split('\n'):
            ...
            if ip.startswith('#'):
                continue
            if not self.he.validIP(ip) and not self.he.validIP6(ip):
                continue
            ips.append(ip)
