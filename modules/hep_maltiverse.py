...
# -------------------------------------------------------------------------------
# Name:         hep_maltiverse
# Purpose:      Hawkeye plugin to search Maltiverse API
...
class hep_maltiverse(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            maliciousIPDescHash = self.he.hashstring(maliciousIPDesc)
