...
class hep_names(HawkEyePlugin):
    ...
    def setup(self, hec, userOpts=dict()):
        ...
        self.d = HawkEyeHelpers.dictionaryWordsFromWordlists()
        self.n = HawkEyeHelpers.humanNamesFromWordlists()
    ...
    def handleEvent(self, event):
        ...
        if eventName == "EMAILADDR" and self.opts['emailtoname']:
            ...
            evt = HawkEyeEvent("HUMAN_NAME", name, self.__name__, event)
        ...
        if eventName == "RAW_RIR_DATA":
            if srcModuleName not in ["hep_builtwith", "hep_clearbit", "hep_emailcrawlr",
                                     "hep_fullcontact", "hep_github", "hep_hunter",
                                     "hep_opencorporates", "hep_slideshare", "hep_jsonwhoiscom",
                                     "hep_twitter", "hep_gravatar", "hep_keybase"]:
