# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_openstreetmap
# Purpose:      HawkEye plug-in to retrieve latitude/longitude coordinates
...
class hep_openstreetmap(HawkEyePlugin):
    ...
    def query(self, qry):
        ...
        res = self.he.fetchUrl("https://nominatim.openstreetmap.org/search?" + urllib.parse.urlencode(params),
                               timeout=self.opts['_fetchtimeout'], useragent='HawkEye')
    ...
    def handleEvent(self, event):
        ...
        for location in data:
            ...
            evt = HawkEyeEvent("PHYSICAL_COORDINATES", coords, self.__name__, event)
            self.notifyListeners(evt)

# End of hep_openstreetmap class
