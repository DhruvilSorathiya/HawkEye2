...
class hep_pastebin(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for dom in list(self.domains.keys()):
            ...
            relevant_links = [
                link for link in new_links if HawkEyeHelpers.urlBaseUrl(link).endswith(target)
            ]
            ...
            for link in relevant_links:
                ...
                res = self.he.fetchUrl(link, timeout=self.opts['_fetchtimeout'],
                                       useragent=self.opts['_useragent'])
