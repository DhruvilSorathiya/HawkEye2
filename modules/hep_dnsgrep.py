...
# -------------------------------------------------------------------------------
# Name:        hep_dnsgrep
# Purpose:     HawkEye plug-in for retrieving domain names
...
class hep_dnsgrep(HawkEyePlugin):
    ...
    def query(self, qry):
        ...
        res = self.he.fetchUrl('https://dns.bufferover.run/dns?' + urllib.parse.urlencode(params),
    ...
    def handleEvent(self, event):
        ...
        for domain in domains:
            ...
            if self.opts["dns_resolve"] and not self.he.resolveHost(domain) and not self.he.resolveHost6(domain):
