...
class hep_googlesearch(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if self.opts['api_key'] == "":
            self.error("You enabled hep_googlesearch but did not set a Google API key!")
        ...
        internal_links = [
            link for link in new_links if self.he.urlFQDN(link).endswith(eventData)
        ]
