...
# -------------------------------------------------------------------------------
# Name:        hep_phishstats
# Purpose:     Hawkeye plugin to search PhishStats API
...
class hep_phishstats(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            evt = HawkEyeEvent("RAW_RIR_DATA", str(data), self.__name__, pevent)
            self.notifyListeners(evt)

            text = f"PhishStats [{addr}]"

            evt = HawkEyeEvent(blacklist_type, text, self.__name__, pevent)
            self.notifyListeners(evt)

            evt = HawkEyeEvent(malicious_type, text, self.__name__, pevent)
            self.notifyListeners(evt)

# End of hep_phishstats class
