...
class hep_abuseipdb(HawkEyePlugin):
    ...
    def queryBlacklist(self):
        blacklist = self.he.cacheGet('abuseipdb', 24)
        ...
        self.he.cachePut("abuseipdb", res['content'])
