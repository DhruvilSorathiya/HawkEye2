# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:        hep_tool_snallygaster
# Purpose:     HawkEye plug-in for using the snallygaster tool.
...
class hep_tool_snallygaster(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if not self.opts['snallygaster_path']:
            self.error("You enabled hep_tool_snallygaster but did not set a path to the tool!")
...
# End of hep_tool_snallygaster class
