...
class hep_email(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        emails = HawkEyeHelpers.extractEmailsFromText(eventData)
        for email in set(emails):
            ...
            if not self.he.validHost(mailDom, self.opts['_internettlds']):
            ...
            evt = HawkEyeEvent(evttype, mail, self.__name__, event)
