# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_dnsneighbor
# Purpose:      HawkEye plug-in for gathering IP addresses from sub-domains
...
class hep_dnsneighbor(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for ip in network:
            ...
            for addr in addrs:
                ...
                if self.he.validIP(addr) or self.he.validIP6(addr):
                    parent = parentEvent
                else:
    ...
    def processHost(self, host, parentEvent, affiliate=None):
        ...
        if affiliate is None:
            ...
            if self.getTarget().matches(host):
                ...
                # list of aliases,
                if not self.he.validIP(host) and not self.he.validIP6(host):
        ...
        # If names were found, leave them to hep_dnsresolve to resolve
        if not htype:
            return None
