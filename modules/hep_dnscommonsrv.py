# -*- coding: utf-8 -*-
# -----------------------------------------------------------------------------
# Name:         hep_dnscommonsrv
# Purpose:      HawkEye plug-in for attempting to resolve through
...
class hep_dnscommonsrv(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if srcModuleName == "hep_dnscommonsrv":
        ...
        for srv in self.commonsrv:
            ...
            if self.he.hashstring(name) in self.events:
                continue
