...
class hep_spamcop(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            for result in res:
                ...
                evt = HawkEyeEvent(blacklist_type, description, self.__name__, event)
                self.notifyListeners(evt)

                evt = HawkEyeEvent(malicious_type, description, self.__name__, event)
                self.notifyListeners(evt)

# End of hep_spamcop class
