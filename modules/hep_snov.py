...
# -------------------------------------------------------------------------------
# Name:         hep_snov
# Purpose:      Hawkeye plugin to search Snov.IO API for emails
...
class hep_snov(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if self.opts['api_key_client_id'] == "" or self.opts['api_key_client_secret'] == "":
            self.error("You enabled hep_snov but did not set a Client ID and/or Client Secret")
            self.errorState = True
            return
