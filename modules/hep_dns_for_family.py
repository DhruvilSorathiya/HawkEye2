...
class hep_dns_for_family(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for result in res:
            ...
            evt = HawkEyeEvent(blacklist_type, f"DNS for Family [{eventData}]", self.__name__, event)
            self.notifyListeners(evt)

# End of hep_dns_for_family class
