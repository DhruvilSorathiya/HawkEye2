...
class hep_hashes(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        hashes = HawkEyeHelpers.extractHashesFromText(eventData)
        for hashtup in hashes:
            hashalgo, hashval = hashtup

            evt = HawkEyeEvent("HASH", f"[{hashalgo}] {hashval}", self.__name__, event)
