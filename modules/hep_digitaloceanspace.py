# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_digitaloceanspace
# Purpose:      HawkEye plug-in for identifying potential Digital Ocean spaces
...
class hep_digitaloceanspace(HawkEyePlugin):
    ...
    def threadSites(self, siteList):
        ...
        for site in siteList:
            ...
            t.append(threading.Thread(name='thread_hep_digitaloceanspaces_' + tname,
        ...
        while running:
            ...
            for rt in threading.enumerate():
                if rt.name.startswith("thread_hep_digitaloceanspaces_"):
                    found = True
    ...
    def handleEvent(self, event):
        ...
        for b in ret:
            ...
            self.notifyListeners(evt)
            if bucket[2] != "0":
                evt = HawkEyeEvent("CLOUD_STORAGE_BUCKET_OPEN", bucket[0] + ":" + bucket[1] + ": " + bucket[2] + " files found.",
                                      self.__name__, evt)
                self.notifyListeners(evt)


# End of hep_digitaloceanspace class
