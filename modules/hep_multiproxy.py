...
class hep_multiproxy(HawkEyePlugin):
    ...
    def retrieveProxyList(self):
        proxy_list = self.he.cacheGet('multiproxyopenproxies', 24)
        ...
        self.he.cachePut("multiproxyopenproxies", res['content'])
