...
class hep_iknowwhatyoudownload(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if self.opts['api_key'] == "":
            self.error("You enabled hep_iknowwhatyoudownload but did not set an API key!")
            self.errorState = True
            return
        ...
        retdata = [f"<HEURL>https://iknowwhatyoudownload.com/en/peer/?ip={eventData}</HEURL>"]
        ...
        e = HawkEyeEvent("MALICIOUS_IPADDR", "\n".join(retdata), self.__name__, event)
        self.notifyListeners(e)

# End of hep_iknowwhatyoudownload class
