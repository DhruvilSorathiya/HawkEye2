    ...
    def handleEvent(self, event):
        ...
        while pagecount < self.opts['pages']:
            ...
            for link in links:
                ...
                if self.he.urlFQDN(link).endswith(".onion"):
                    if self.checkForStop():
                        return
                    if self.opts['fetchlinks']:
                        ...
                        evt = HawkEyeEvent("DARKNET_MENTION_CONTENT", f"...{darkcontent}...",
                                              self.__name__, evt)
                        self.notifyListeners(evt)
