# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_tool_wappalyzer
# Purpose:      HawkEye plug-in for using the 'Wappalyzer' tool.
...
class hep_tool_wappalyzer(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if not self.opts['wappalyzer_path']:
            self.error("You enabled hep_tool_wappalyzer but did not set a path to the tool!")
...
# End of hep_tool_wappalyzer class
