...
class hep_cybercrimetracker(HawkEyePlugin):
    ...
    def retrieveBlacklist(self):
        blacklist = self.he.cacheGet('cybercrime-tracker', 24)
        ...
        self.he.cachePut("cybercrime-tracker", res['content'])
...
# End of hep_cybercrimetracker class
