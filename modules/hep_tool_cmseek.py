# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_tool_cmseek
# Purpose:      HawkEye plug-in for using the 'CMSeeK' tool.
...
class hep_tool_cmseek(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if not self.opts['cmseekpath']:
            self.error("You enabled hep_tool_cmseek but did not set a path to the tool!")
