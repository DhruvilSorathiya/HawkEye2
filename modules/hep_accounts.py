...
class hep_accounts(HawkEyePlugin):
    ...
    def setup(self, hec, userOpts=dict()):
        ...
        self.commonNames = HawkEyeHelpers.humanNamesFromWordlists()
        self.words = HawkEyeHelpers.dictionaryWordsFromWordlists()

        content = self.he.cacheGet("heaccountsv2", 48)
        if content is None:
            url = "https://raw.githubusercontent.com/WebBreacher/WhatsMyName/main/wmn-data.json"
            data = self.he.fetchUrl(url, useragent="HawkEye")
            ...
            self.he.cachePut("heaccountsv2", content)
    ...
    def handleEvent(self, event):
        ...
        if eventName != "USERNAME" and srcModuleName == "p_accounts":
        ...
        if not self.distrustedChecked:
            ...
            content = self.he.cacheGet("heaccounts_state_v3", 72)
            if content:
                ...
                if res:
                    ...
                    delsites = "None"
                self.he.cachePut("heaccounts_state_v3", delsites)
        ...
        for user in set(users):
            ...
            if user not in self.reportedUsers and eventData != user:
                ...
                evt = HawkEyeEvent("USERNAME", user, self.__name__, event)
