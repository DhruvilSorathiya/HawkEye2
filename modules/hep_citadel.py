...
class hep_citadel(HawkEyePlugin):
    ...
    def queryEmail(self, email):
        ...
        res = self.he.fetchUrl("https://leak-lookup.com/api/search",
    ...
    def handleEvent(self, event):
        ...
        for site in message:
            ...
            evt = HawkEyeEvent("EMAILADDR_COMPROMISED", f"{eventData} [{site}]", self.__name__, event)
            self.notifyListeners(evt)

# End of hep_citadel class
