...
class hep_google_tag_manager(HawkEyePlugin):
    ...
    def queryGoogleTagId(self, tag_id: str = None) -> set:
        ...
        for url in HawkEyeHelpers.extractUrlsFromText(str(data).replace("\\/", "/")):
...
# End of hep_google_tag_manager class
