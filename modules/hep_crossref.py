...
class hep_crossref(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if not self.he.resolveHost(fqdn) and not self.he.resolveHost6(fqdn):
        ...
        if not matched:
            ...
            if eventName == "LINKED_URL_EXTERNAL" and self.opts['checkbase']:
                ...
                url = HawkEyeHelpers.urlBaseUrl(eventData)
