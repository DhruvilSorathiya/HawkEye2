...
class hep_subdomain_takeover(HawkEyePlugin):
    ...
    def setup(self, hec, userOpts=dict()):
        ...
        content = self.he.cacheGet("subjack-fingerprints", 48)
        if content is None:
            url = "https://raw.githubusercontent.com/haccer/subjack/master/fingerprints.json"
            res = self.he.fetchUrl(url, useragent="HawkEye")
            ...
            self.he.cachePut("subjack-fingerprints", res['content'])
            content = res['content']
                    ...
                    for proto in ["https", "http"]:
                        ...
                        for fingerprint in fingerprints:
                            if fingerprint in res['content']:
                                ...
                                evt = HawkEyeEvent("AFFILIATE_INTERNET_NAME_HIJACKABLE", eventData, self.__name__, event)
...
# End of hep_subdomain_takeover class
