...
class hep_psbdmp(HawkEyePlugin):
    ...
    def query(self, qry):
        ...
        res = self.he.fetchUrl(url, timeout=15, useragent="HawkEye")
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            e = HawkEyeEvent("LEAKSITE_URL", n, self.__name__, event)
            ...
            evt = HawkEyeEvent("LEAKSITE_CONTENT", res['content'], self.__name__, e)
            self.notifyListeners(evt)

# End of hep_psbdmp class
