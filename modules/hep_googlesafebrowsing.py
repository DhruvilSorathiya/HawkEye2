# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_googlesafebrowsing
# Purpose:      HawkEye plug-in to check if the URL is included on any of the
...
class hep_googlesafebrowsing(HawkEyePlugin):
    ...
    def query(self, qry):
        ...
        payload = {
            "client": {"clientId": "HawkEye", "clientVersion": "3.2"},
            "threatInfo": {
                "threatTypes": [
    ...
    def handleEvent(self, event):
        ...
        if self.opts["api_key"] == "":
            self.error(
                "You enabled hep_googlesafebrowsing but did not set an API key!"
            )
            self.errorState = True
            return
...
# End of hep_googlesafebrowsing class
