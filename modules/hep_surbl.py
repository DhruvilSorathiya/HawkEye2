...
# -------------------------------------------------------------------------------
# Name:        hep_surbl
# Purpose:     HawkEye plug-in to check whether IP addresses, netblocks, and
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            for result in res:
                ...
                evt = HawkEyeEvent(blacklist_type, f"SURBL [{addr}]", self.__name__, event)
                self.notifyListeners(evt)

                evt = HawkEyeEvent(malicious_type, f"SURBL [{addr}]", self.__name__, event)
                self.notifyListeners(evt)

# End of hep_surbl class
