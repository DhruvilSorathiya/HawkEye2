...
class hep_slideshare(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        e = HawkEyeEvent("RAW_RIR_DATA", f"Possible full name: {human_name[0]}", self.__name__, event)
        ...
        e = HawkEyeEvent("GEOINFO", location[0], self.__name__, event)
        self.notifyListeners(e)

# End of hep_slideshare class
