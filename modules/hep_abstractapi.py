...
class hep_abstractapi(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if eventName == "DOMAIN_NAME":
            ...
            e = HawkEyeEvent("COMPANY_NAME", name, self.__name__, event)
            self.notifyListeners(e)
            ...
            if linkedin_url:
                ...
                e = HawkEyeEvent("SOCIAL_MEDIA", f"LinkedIn (Company): <HEURL>{linkedin_url}</HEURL>", self.__name__, event)
                self.notifyListeners(e)
            ...
            if geoinfo:
                e = HawkEyeEvent("GEOINFO", geoinfo, self.__name__, event)
                self.notifyListeners(e)
            ...
            if carrier:
                e = HawkEyeEvent("PROVIDER_TELCO", carrier, self.__name__, event)
                self.notifyListeners(e)
            ...
            if latitude and longitude:
                e = HawkEyeEvent("PHYSICAL_COORDINATES", f"{latitude}, {longitude}", self.__name__, event)
                self.notifyListeners(e)

# End of hep_abstractapi class
