...
class hep_openbugbounty(HawkEyePlugin):
        ...
        try:
            ...
            for m in rx.findall(str(res['content'])):
                ...
                if m[1] == qry or m[1].endswith("." + qry):
                    ret.append("From openbugbounty.org: <HEURL>" + base + m[0] + "</HEURL>")
    ...
    def handleEvent(self, event):
        ...
        for n in data:
            ...
            e = HawkEyeEvent("VULNERABILITY_DISCLOSURE", n, self.__name__, event)
            self.notifyListeners(e)

# End of hep_openbugbounty class
