...
class hep_commoncrawl(HawkEyePlugin):
    ...
    def search(self, target):
        ...
        for index in self.indexBase:
            ...
            res = self.he.fetchUrl(url, timeout=60,
                                   useragent="HawkEye")
        ...
        for content in data:
            try:
                for line in content.split("\n"):
                    ...
                    evt = HawkEyeEvent("LINKED_URL_INTERNAL", link['url'],
                                          self.__name__, event)
