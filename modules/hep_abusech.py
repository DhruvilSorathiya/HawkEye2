...
class hep_abusech(HawkEyePlugin):
    ...
    def retrieveFeodoTrackerBlacklist(self):
        blacklist = self.he.cacheGet('abusech_feodo', 24)
        ...
        self.he.cachePut("abusech_feodo", res['content'])
    ...
    def retrieveSslBlacklist(self):
        blacklist = self.he.cacheGet('abusech_ssl', 24)
        ...
        self.he.cachePut("abusech_ssl", res['content'])
    ...
    def retrieveUrlHausBlacklist(self):
        blacklist = self.he.cacheGet('abusech_urlhaus', 24)
        ...
        self.he.cachePut("abusech_urlhaus", res['content'])
    ...
    def parseUrlHausBlacklist(self, blacklist):
        ...
        for line in blacklist.split('\n'):
            ...
            # Note: URL parsing and validation with he.validHost() is too slow to use here
    ...
    def handleEvent(self, event):
        ...
        if targetType in ['ip', 'netblock']:
            ...
            if self.queryFeodoTrackerBlacklist(eventData, targetType):
                ...
                evt = HawkEyeEvent(evtType, text, self.__name__, event)
