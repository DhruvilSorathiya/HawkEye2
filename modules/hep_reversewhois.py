...
class hep_reversewhois(HawkEyePlugin):
    ...
    def query(self, qry):
        ...
        res = self.he.fetchUrl(url, timeout=self.opts.get("_fetchtimeout", 30))
    ...
    def handleEvent(self, event):
        ...
        for registrar in set(registrars):
            e = HawkEyeEvent("DOMAIN_REGISTRAR", registrar, self.__name__, event)
            self.notifyListeners(e)

# End of hep_reversewhois class
