...
class hep_arin(HawkEyePlugin):
    ...
    def query(self, qtype, value):
        ...
        evt = HawkEyeEvent("RAW_RIR_DATA", str(data), self.__name__, self.currentEventSrc)
            ...
            if "pocs" in ret:
                if "pocRef" in ret['pocs']:
                    ...
                    for p in ref:
                        ...
                        evt = HawkEyeEvent("HUMAN_NAME", name,
