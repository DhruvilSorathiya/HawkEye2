...
# -------------------------------------------------------------------------------
# Name:         hep_s3bucket
# Purpose:      HawkEye plug-in for identifying potential S3 buckets related to
#               the target.
#
...
class hep_s3bucket(HawkEyePlugin):
    ...
    def threadSites(self, siteList):
        ...
        for i, site in enumerate(siteList):
            ...
            t.append(threading.Thread(name='thread_hep_s3buckets_' + tname,
        ...
        while running:
            ...
            for rt in threading.enumerate():
                if rt.name.startswith("thread_hep_s3buckets_"):
                    found = True
