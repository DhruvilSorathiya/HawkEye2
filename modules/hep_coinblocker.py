...
class hep_coinblocker(HawkEyePlugin):
    ...
    def retrieveBlocklist(self):
        blocklist = self.he.cacheGet('coinblocker', self.opts.get('cacheperiod', 24))
        ...
        self.he.cachePut("coinblocker", res['content'])
