...
class hep_threatcrowd(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for addr in qrylist:
            ...
            if info.get('votes', 0) < 0:
                ...
                infourl = "<HEURL>" + info.get('permalink') + "</HEURL>"

                # Notify other modules of what you've found
                e = HawkEyeEvent(evt, "ThreatCrowd [" + addr + "]\n" + infourl, self.__name__, event)
                self.notifyListeners(e)

# End of hep_threatcrowd class
