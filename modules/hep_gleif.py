    ...
    def handleEvent(self, event):
        ...
        if eventName == "LEI":
            ...
            for record in res:
                ...
                lei = data.get('id')
                if not HawkEyeHelpers.validLEI(lei):
                    continue
        ...
        for lei in set(leis):
            ...
            e = HawkEyeEvent("LEI", lei, self.__name__, event)
            self.notifyListeners(e)
            ...
            if legal_name:
                ...
                if entity_name:
                    e = HawkEyeEvent("COMPANY_NAME", entity_name, self.__name__, event)
                    self.notifyListeners(e)
            ...
            for address in set(addresses):
                e = HawkEyeEvent("PHYSICAL_ADDRESS", address, self.__name__, event)
                self.notifyListeners(e)

# End of hep_gleif class
