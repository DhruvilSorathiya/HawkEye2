...
class hep_alienvaultiprep(HawkEyePlugin):
    ...
    def retrieveBlacklist(self):
        blacklist = self.he.cacheGet('alienvaultiprep', 24)
        ...
        self.he.cachePut("alienvaultiprep", res['content'])
...
# End of hep_alienvaultiprep class
