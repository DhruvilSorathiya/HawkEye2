...
class hep_certspotter(HawkEyePlugin):
    meta = {
        'name': "CertSpotter",
        ...
        while page <= max_pages:
            ...
            for result in data:
                ...
                try:
                    ...
                    rawcert += "\n-----END CERTIFICATE-----\n"
                    cert = self.he.parseCert(rawcert, eventData, self.opts['certexpiringdays'])
                except Exception as e:
                ...
                evt = HawkEyeEvent('SSL_CERTIFICATE_RAW', cert['text'], self.__name__, event)
                self.notifyListeners(evt)
