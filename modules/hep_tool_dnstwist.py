# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_tool_dnstwist
# Purpose:      HawkEye plug-in for using the 'dnstwist' tool.
...
class hep_tool_dnstwist(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        dom = self.he.domainKeyword(eventData, self.opts['_internettlds'])
        if not dom:
        ...
        if dnstwistLocation and Path(dnstwistLocation).is_file():
            ...
            if not self.opts['dnstwistpath']:
                self.error("You enabled hep_tool_dnstwist but did not set a path to the tool!")
        ...
        try:
            ...
            try:
                ...
                for r in j:
                    ...
                    evt = HawkEyeEvent("SIMILARDOMAIN", domain,
                                          self.__name__, event)
...
# End of hep_tool_dnstwist class
