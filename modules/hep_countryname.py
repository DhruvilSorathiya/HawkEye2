# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_countryname
# Purpose:      HawkEye plug-in for scanning retrieved content by other
#               modules (such as hep_iban, hep_phone, hep_whois) and identifying country names
#
...
class hep_countryname(HawkEyePlugin):
    ...
    def detectCountryFromPhone(self, srcPhoneNumber: str) -> str:
        ...
        return HawkEyeHelpers.countryNameFromCountryCode(countryCode.upper())
    ...
    def detectCountryFromDomainName(self, srcDomain: str) -> str:
        ...
        for part in domainParts[::-1]:
            country_name = HawkEyeHelpers.countryNameFromTld(part)
            if country_name:
                return country_name
    ...
    def detectCountryFromIBAN(self, srcIBAN: str) -> str:
        ...
        return HawkEyeHelpers.countryNameFromCountryCode(srcIBAN[0:2])
    ...
    def detectCountryFromData(self, srcData: str) -> list:
        ...
        abbvCountryCodes = HawkEyeHelpers.countryCodes()
    ...
    def handleEvent(self, event):
        ...
        for countryName in set(countryNames):
            ...
            evt = HawkEyeEvent("COUNTRY_NAME", countryName, self.__name__, event)
            evt.moduleDataSource = moduleDataSource
            self.notifyListeners(evt)

# End of hep_countryname class
