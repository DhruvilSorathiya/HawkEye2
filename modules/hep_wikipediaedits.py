...
class hep_wikipediaedits(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        for link in data:
            evt = HawkEyeEvent("WIKIPEDIA_PAGE_EDIT", link, self.__name__, event)
            self.notifyListeners(evt)

# End of hep_wikipediaedits class
