# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:         hep_emailformat
# Purpose:      HawkEye plug-in for retrieving e-mail addresses
...
class hep_emailformat(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        res = self.he.fetchUrl(f"https://www.email-format.com/d/{eventData}/", timeout=self.opts['_fetchtimeout'], useragent=self.opts['_useragent'])
        ...
        emails = HawkEyeHelpers.extractEmailsFromText(data)
        for email in emails:
