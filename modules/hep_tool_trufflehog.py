# -*- coding: utf-8 -*-
# -------------------------------------------------------------------------------
# Name:        hep_tool_trufflehog
# Purpose:     HawkEye plug-in for using the trufflehog tool.
...
from hawkeye import HawkEyePlugin, HawkEyeEvent


class hep_tool_trufflehog(HawkEyePlugin):
    ...
    def handleEvent(self, event):
        ...
        if not self.opts['trufflehog_path']:
            self.error("You enabled hep_tool_trufflehog but did not set a path to the tool!")
        ...
        for row in stdout.split("\n"):
            ...
            evt = HawkEyeEvent('PASSWORD_COMPROMISED', descr, self.__name__, event)
            self.notifyListeners(evt)

        return

# End of hep_tool_trufflehog class
